/**
 * File: FlowHighlighter.cpp
 * Description: The implementation of the FlowHighlighter class.
...
namespace hbchart {
    // -- Implementation of FlowHighlighter --
    FlowHighlighter::FlowHighlighter(QTextDocument* parent) : SyntaxHighlighter(parent) {
  ...
  void FlowHighlighter::setErrorLine(int line) {
      m_errorLine = line;
  ...
  void FlowHighlighter::highlightBlock(const QString& text) {
