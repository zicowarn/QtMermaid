/**
 * File: GanttChartView.h
 * Description: The declaration of the GanttChartView class.
 ...
 */
#ifndef GANTTCHARTVIEW_H
#define GANTTCHARTVIEW_H
...
namespace hbchart {
    ...
    /**
     * @brief GanttChart view
     * @details Inherits from QGraphicsView, used for drawing GanttCharts
     * @note
     * Note: This class is only for GanttChart drawing, not for node and connection interactions.
     * Mainly implements zooming, panning, dragging and other functions.
     */
    class GanttChartView : public QGraphicsView {
        Q_OBJECT
      ...
      public:
         ...
         */
        explicit GanttChartView(QGraphicsScene* scene, QWidget* parent = nullptr);
        ~GanttChartView() override = default; ///< Destructor
